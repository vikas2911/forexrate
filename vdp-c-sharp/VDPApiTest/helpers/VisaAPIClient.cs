    ...
    public class VisaAPIClient
    {
        ...
        private void LogResponse(string info, HttpWebResponse response)
        {
            ...
            using (var reader = new StreamReader(response.GetResponseStream(), ASCIIEncoding.ASCII))
            {
                ...
                File.WriteAllText("c:\\VisaResponse.text", responseBody); 
            }
        ...
        public string DoMutualAuthCallTls12(string path, string method, string testInfo, string requestBodyString, Dictionary<string, string> headers = null)
        {
            string requestURL = ConfigurationManager.AppSettings["visaUrl"] + path; 
            string userId = ConfigurationManager.AppSettings["userId"];
            string password = ConfigurationManager.AppSettings["password"];
            ...
            // Add certificate
            var certificate = new X509Certificate2("c:\\myapp_keyAndCertBundle.p12", "123456");
            request.ClientCertificates.Add(certificate);
        ...
        public string HelloWorld(string method, string testInfo, Dictionary<string, string> headers = null)
        {
